...
function get_admin_links(){
    ...
    <ul class="nav nav-pills justify-content-center">
        ...
        <li class="nav-item"><a class="nav-link" href="/library/admin/get_all_authors.php">Показать всех авторов</a></li>
        <li class="nav-item"><a class="nav-link" href="/library/admin/get_all_genres.php">Показать все жанры</a></li>
    </ul>
';
